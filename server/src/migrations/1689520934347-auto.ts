...
export class Auto1689520934347 implements MigrationInterface {
    name = 'Auto1689520934347'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "t_keywords" ("id" SERIAL NOT NULL, "result_id" integer, CONSTRAINT "PK_6970af66ac47e0f5b8f5dd12e4e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "topvisor_project" ALTER COLUMN "date_last_update" SET DEFAULT '"2023-07-16T15:22:20.658Z"'`);
        await queryRunner.query(`ALTER TABLE "yandex_project" ALTER COLUMN "date_last_update" SET DEFAULT '"2023-07-16T15:22:20.915Z"'`);
